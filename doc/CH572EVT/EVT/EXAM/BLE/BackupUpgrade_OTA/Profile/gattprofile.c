...
static uint8_t simpleProfileChar4UserDesp[7] = "Char 4\0";

// Simple Profile Characteristic 5 Properties
static uint8_t simpleProfileChar5Props = GATT_PROP_READ;

// Characteristic 5 Value
static uint8_t simpleProfileChar5[SIMPLEPROFILE_CHAR5_LEN] = {0, 0, 0, 0, 0};

// Simple Profile Characteristic 5 User Description
static uint8_t simpleProfileChar5UserDesp[7] = "Char 5\0";
...
bStatus_t SimpleProfile_SetParameter(uint8_t param, uint8_t len, void *value)
{
    ...
    switch(param)
    {
        case SIMPLEPROFILE_CHAR1:
            ...
            {
                simpleProfileChar1 = *((uint8_t *)value);
            }
            else
            {
                ret = bleInvalidRange;
        ...
        case SIMPLEPROFILE_CHAR2:
            if(len == sizeof(uint8_t))
            {
                simpleProfileChar2 = *((uint8_t *)value);
            }
            else
            {
                ret = bleInvalidRange;
        ...
        case SIMPLEPROFILE_CHAR3:
            if(len == sizeof(uint8_t))
            {
                simpleProfileChar3 = *((uint8_t *)value);
            }
            else
            {
                ret = bleInvalidRange;
        ...
        case SIMPLEPROFILE_CHAR4:
            if(len == sizeof(uint8_t))
            {
                simpleProfileChar4 = *((uint8_t *)value);
            }
            else
            {
                ret = bleInvalidRange;
...
bStatus_t SimpleProfile_GetParameter(uint8_t param, void *value)
{
    ...
    {
        case SIMPLEPROFILE_CHAR1:
            *((uint8_t *)value) = simpleProfileChar1;
            break;

        case SIMPLEPROFILE_CHAR2:
            *((uint8_t *)value) = simpleProfileChar2;
            break;

        case SIMPLEPROFILE_CHAR3:
            *((uint8_t *)value) = simpleProfileChar3;
            break;

        case SIMPLEPROFILE_CHAR4:
            *((uint8_t *)value) = simpleProfileChar4;
            break;
